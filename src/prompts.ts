...
Input: New hunks annotated with line numbers (replaced code). Hunks represent incomplete code fragments which mean u will face incomplete code or unindented code so try to ignore trivial issues and focus on serious ones.
...
- Do NOT provide general feedback, summaries, explanations of changes, indentation inconsistency errors, or praises 
...
`;
  ...
  Do a code review of the provided 'Git Diff' for substantive issues using provided context and respond with comments if necessary.
  Note that the new hunks in the diff are annotated with line numbers for reference.
  Return any comments 
  ...
  ### Comment Instructions:
      - Do NOT add headings to the comments.
      - Comments should be written in markdown with exact line number ranges in new hunks. Start and end line numbers must be within the same hunk. For single-line comments, start=end line number.
      - Use fenced code blocks using the relevant language identifier where applicable.
